const Catalog = require('../../../libs/service/src/repository/catalog/catalog');
  ...
  insert = async (req, res, next) => {
    try {
      ...
      const user = await this.create({
        ...
        ...(inputDto.categoryId && {categoryId: inputDto.categoryId }),
        ...(inputDto.subCategoryId && {categoryId: inputDto.subCategoryId })
      });
